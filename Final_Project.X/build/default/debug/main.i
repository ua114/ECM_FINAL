...
void storeIR(unsigned int *IR_R, unsigned int *IR_L) {
    *IR_L = ((CAP1BUFH << 8) | CAP1BUFL);
    *IR_R = ((CAP2BUFH << 8) | CAP2BUFL);
}
...
void LCDout(unsigned char number){
    ...
    if (number & 0b1000){LATDbits.LATD1=0b0001;} else{LATDbits.LATD1=0;}
    if (number & 0b0100){LATDbits.LATD0=0b0001;} else{LATDbits.LATD0=0;}
    if (number & 0b0010){LATCbits.LATC2=0b0001;} else{LATCbits.LATC2=0;}
    if (number & 0b0001){LATCbits.LATC1=0b0001;} else{LATCbits.LATC1=0;}
    E_TOG();
    _delay((unsigned long)((5)*(8000000/4000000.0)));
}
